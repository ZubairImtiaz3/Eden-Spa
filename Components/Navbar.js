...
function Navbar() {
  ...
  return (
    <>
      <nav className="max-w-[85.83%] mx-auto mt-8 xl:mt-[3.25rem] flex justify-between items-center">
        <ul className="gap-[4.5rem] hidden xl:flex">
          ...
          <li>
            <a className="font-Poppins text-[#969696] text-base">Store</a>
          </li>
          <li>
            <a className="font-Poppins text-[#969696] text-base">Blog</a>
          </li>
        </ul>
        ...
        <ul className="gap-[4.5rem] items-center hidden xl:flex">
          <li>
            <a className="font-Poppins text-[#969696] text-base">
              Trust & Safety
            </a>
          </li>
          <li>
